class ArticulosController < ApplicationController
  ...
  private
    ...
    def articulo_params
      params.require(:articulo).permit(:solicitud_id, :clues_id, :partida_id, :clave_id, :descripcion, :presentacion, :marca_mod, :cantidad, :precio, :caducidad, :almacen_id, :entregas, :requisicion_id, :renglon_id, :capacitacion, :muestra, :notas, :anexos, :user_id, :proceso_id, :ped_id, :catalogo_id, :comprar, :adquirido, :cancelado)
    end
end
