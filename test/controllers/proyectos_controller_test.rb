...
class ProyectosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proyecto" do
    assert_difference('Proyecto.count') do
      post proyectos_url, params: { proyecto: { clave: @proyecto.clave, periodo: @proyecto.periodo, proyecto: @proyecto.proyecto } }
    end
  ...
  test "should update proyecto" do
    patch proyecto_url(@proyecto), params: { proyecto: { clave: @proyecto.clave, periodo: @proyecto.periodo, proyecto: @proyecto.proyecto } }
