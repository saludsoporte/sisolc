...
class MunicipiosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create municipio" do
    assert_difference('Municipio.count') do
      post municipios_url, params: { municipio: { estado: @municipio.estado, juris: @municipio.juris, municipio: @municipio.municipio } }
    end
  ...
  test "should update municipio" do
    patch municipio_url(@municipio), params: { municipio: { estado: @municipio.estado, juris: @municipio.juris, municipio: @municipio.municipio } }
