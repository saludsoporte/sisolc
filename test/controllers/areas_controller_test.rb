...
class AreasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create area" do
    assert_difference('Area.count') do
      post areas_url, params: { area: { area: @area.area, area_abrev: @area.area_abrev, estructura_id: @area.estructura_id } }
    end
  ...
  test "should update area" do
    patch area_url(@area), params: { area: { area: @area.area, area_abrev: @area.area_abrev, estructura_id: @area.estructura_id } }
