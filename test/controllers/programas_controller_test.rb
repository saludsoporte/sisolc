...
class ProgramasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create programa" do
    assert_difference('Programa.count') do
      post programas_url, params: { programa: { clave: @programa.clave, numpro: @programa.numpro, programa: @programa.programa } }
    end
  ...
  test "should update programa" do
    patch programa_url(@programa), params: { programa: { clave: @programa.clave, numpro: @programa.numpro, programa: @programa.programa } }
